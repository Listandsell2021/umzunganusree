...
async function checkemail(ids,data)
{
   ...
   const response = await axios.post('http://localhost:3000/api/getAdminbyemail', {
    ids
     })
...
"username":data.username}
  ...
  const responselogin = await axios.post('http://localhost:3000/api/postLogin', {
    logindata
  })
  const responsenavigations= await axios.post('http://localhost:3000/api/postNavigationMenu', {
    navigationData
  })
